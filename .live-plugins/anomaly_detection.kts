...
val venvPython = "H:/Documents/Apply/Applications/TU Delft/Assessment/test-assignment/venv38/Scripts/python.exe"

// Define the Python script file
val pythonScript = "H:/Documents/Apply/Applications/TU Delft/Assessment/test-assignment/detection/trace_classifier/anomaly_detection.py"
